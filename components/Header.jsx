...
function Header(){
    ...
    return(
        <header className="w-full p-6 sticky top-0 bg-white">
        <div className="flex w-full items-center ">
            ...
            ">
                ...
                className="flex-grow w-full focus:outline-none"
                 ...
                 />
                 <MicrophoneIcon className="h-7 mr-3 hidden sm:inline-flex text-blue-500  border-l-2 pl-4 border-gray-200"/>
